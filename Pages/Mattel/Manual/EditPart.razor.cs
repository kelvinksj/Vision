...
public partial class EditPart : IDisposable
{
    ...
    private MessageLevel settingLevel => DebugParameters.MsgLvl_EditPart;
    ...
    private string? TempPartNumber;
    private string? BackupPartNumber;
    private string ConfirmButtonColor => string.IsNullOrWhiteSpace(list.PartNumber)
    ...
    protected override void OnInitialized()
    {
        ...
        BackupPartNumber = list.PartNumber;
        TempPartNumber = list.PartNumber;
        base.OnInitialized();
    }
    ...
    {
        TempPartNumber = e.Value?.ToString()?.Replace(" ", string.Empty);
        await InvokeAsync(StateHasChanged);
    }

    private async Task CloseModal()
    {
        TempPartNumber = BackupPartNumber;
    ...
    private async Task Confirm()
    {
        if (TempPartNumber != null)
            list.PartNumber = TempPartNumber;

        list.PartNumber = list.PartNumber.Replace(" ", string.Empty);
