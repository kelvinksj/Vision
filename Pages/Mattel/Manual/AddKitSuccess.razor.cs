...
public partial class AddKitSuccess : IDisposable
{
    private string taskName = "AddKitSuccess";
    private MessageLevel settingLevel => DebugParameters.MsgLvl_AddKitSuccess;
