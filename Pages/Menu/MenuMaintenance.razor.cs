...
public partial class MenuMaintenance
{
    private string taskName = "MenuLine";
    private MessageLevel settingLevel => DebugParameters.MsgLvl_MenuMaintenance;
    ...
    {
        NavigationManager.NavigateTo("Setting/Settings", true, true);
    }

    private void Navigate2()
    {
        NavigationManager.NavigateTo("Mattel/MoveRobot", true, true);
    }

    private void Navigate3()
    {
        NavigationManager.NavigateTo("Mattel/MoveTable", true, true);
    }

    private void Navigate4()
    {
        NavigationManager.NavigateTo("Mattel/CheckInMaintenance", true, true);
    }
}