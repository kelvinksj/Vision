...
public partial class MsgList : IDisposable
{
    [Parameter]
    public Models.Common.MsgList MList { get; set; } = new();

    private static string taskName = "MsgList";
    private static MessageLevel settingLevel => DebugParameters.MsgLvl_MsgList;
    ...
    public async Task OnClickMsgCancel(MsgData MsgData)
    {
        CommonLib.DisplayConsole(
           taskName,
           $"OnClickMsgCancel triggered",
           settingLevel,
           MessageLevel.Information
       );
