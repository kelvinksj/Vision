...
public partial class PopMsg : IDisposable
{
    [Parameter]
    public PopMsgData PopMsgData { get; set; } = new();

    private static string taskName = "PopMsg";
    private static MessageLevel settingLevel => DebugParameters.MsgLvl_PopMsgData;
