...
public partial class CPCN : IDisposable
{
    [Parameter]
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        try
        {
            ...
            if (ParentVariable3 is MattelClass.CPCSetup)
            {
                cPCSetup = ParentVariable3;
            }
            else
            {
                cPCSetup.Header1 = "Unknown";
                cPCSetup.Header2 = "Unknown";
