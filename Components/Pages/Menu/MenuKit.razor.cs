...
public partial class MenuKit
{
    private string taskName = "MenuKit";
    private MessageLevel settingLevel => DebugParameters.MsgLvl_MenuKit;
    ...
    {
        NavigationManager.NavigateTo("Mattel/Scan/ScanOne", true, true);
    }
